---
base: main
branch: feature/mvp-04-baseline-perception
capabilities:
  mcp:
    optional:
    - codex_app
...
completion:
  ...
  - branch-diff-check
dependencies:
- mvp-03-dependencies-arbitration
id: mvp-04-baseline-perception
legacy_source: project/WorkOrders/mvp-04-baseline-perception.md
...
scope:
  ...
  owns:
  - '**'
title: MVP-04 — Baseline perception provider
---

# Codex-native execution overlay

This Work Order was converted from `project/WorkOrders/mvp-04-baseline-perception.md`. This overlay overrides any
