---
base: main
branch: feature/mvp-07-reactions-events-effects
capabilities:
  mcp:
    optional:
    - codex_app
...
completion:
  ...
  - branch-diff-check
dependencies:
- mvp-06-action-resolution
id: mvp-07-reactions-events-effects
legacy_source: project/WorkOrders/mvp-07-reactions-events-effects.md
...
scope:
  ...
  owns:
  - '**'
title: MVP-07 — Bounded reactions, events, and effects
---

# Codex-native execution overlay

This Work Order was converted from `project/WorkOrders/mvp-07-reactions-events-effects.md`. This overlay overrides any
