---
base: main
branch: feature/mvp-05-intent-selection
capabilities:
  mcp:
    optional:
    - codex_app
...
completion:
  ...
  - branch-diff-check
dependencies:
- mvp-04-baseline-perception
id: mvp-05-intent-selection
legacy_source: project/WorkOrders/mvp-05-intent-selection.md
...
scope:
  ...
  owns:
  - '**'
title: MVP-05 — Action candidates and utility intent selection
---

# Codex-native execution overlay

This Work Order was converted from `project/WorkOrders/mvp-05-intent-selection.md`. This overlay overrides any
